...
Begin VB.Form frmCrateBatchTransaction 
   ...
   ClientTop       =   690
   ClientWidth     =   15465
   Icon            =   "frmCrateBatchTransaction.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8715
   ...
   Begin VB.Frame Frame2 
      ...
      Begin MSDataListLib.DataCombo cbofacility 
         Bindings        =   "frmCrateBatchTransaction.frx":0E42
         DataField       =   "ItemCode"
         Height          =   315
         Left            =   1320
         TabIndex        =   22
      ...
      Begin MSDataListLib.DataCombo cboplantbatch 
         Bindings        =   "frmCrateBatchTransaction.frx":0E57
         DataField       =   "ItemCode"
         Height          =   315
         Left            =   480
         TabIndex        =   23
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VSFlex7Ctl.VSFlexGrid Mygrid 
         ...
         FormatString    =   $"frmCrateBatchTransaction.frx":0E6C
         ScrollTrack     =   0   'False
         ScrollBars      =   2
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.Frame frmaddcrate 
         ...
         Begin VB.CommandButton Command6 
            ...
            Height          =   495
            Left            =   1200
            Picture         =   "frmCrateBatchTransaction.frx":0EEA
            Style           =   1  'Graphical
            TabIndex        =   34
            Top             =   720
            Width           =   975
      ...
      Begin VB.CommandButton Command5 
         ...
         Height          =   495
         Left            =   6480
         Picture         =   "frmCrateBatchTransaction.frx":1694
         Style           =   1  'Graphical
         TabIndex        =   31
         Top             =   7320
         Width           =   1095
      ...
      Begin VB.CommandButton Command2 
         ...
         Height          =   495
         Left            =   5400
         Picture         =   "frmCrateBatchTransaction.frx":1F5E
         Style           =   1  'Graphical
         TabIndex        =   21
         Top             =   7320
         Width           =   975
      ...
      Begin VB.ListBox DZLIST 
         ...
         EndProperty
         Height          =   6585
         ItemData        =   "frmCrateBatchTransaction.frx":22E8
         Left            =   120
         List            =   "frmCrateBatchTransaction.frx":22EA
         Style           =   1  'Checkbox
         TabIndex        =   5
         Top             =   600
         Width           =   7455
   ...
   Begin VB.Frame Frame1 
      ...
      Begin MSDataListLib.DataCombo cbotrnid 
         Bindings        =   "frmCrateBatchTransaction.frx":22EC
         DataField       =   "ItemCode"
         Height          =   360
         Left            =   1440
         TabIndex        =   1
      ...
      Begin MSDataListLib.DataCombo cbostaff 
         Bindings        =   "frmCrateBatchTransaction.frx":2301
         DataField       =   "ItemCode"
         Height          =   315
         Left            =   1440
         TabIndex        =   28
   ...
   Begin MSComctlLib.ImageList IMG 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCrateBatchTransaction.frx":2316
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCrateBatchTransaction.frx":26B0
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCrateBatchTransaction.frx":2A4A
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCrateBatchTransaction.frx":3724
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCrateBatchTransaction.frx":3B76
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCrateBatchTransaction.frx":4330
            Key             =   ""
         EndProperty
      EndProperty
   End
...
MHVDB.Execute "INSERT INTO tblqmsplanttransaction (trnid,entrydate,plantbatch,varietyid," _
            ...
            & "'2','4', " _
            & "'" & cbostaff.BoundText & "','0','" & Val(ItemGrd.TextMatrix(i, 6)) & "','ON','" & Mlocation & "','" & cbotrnid.BoundText & "','" & Trim(ItemGrd.TextMatrix(i, 5)) & "','" & Trim(ItemGrd.TextMatrix(i, 4)) & "','" & Val(txtyr.Text) & "')"
      ...
      MHVDB.Execute "INSERT INTO tblqmsnutdetail (trnid,entrydate,plantbatch,varietyid," _
            ...
            & "'" & mPlantVariety & "','" & Trim(ItemGrd.TextMatrix(i, 3)) & "'," _
            & "'GN','4', " _
            & "'0','" & Val(ItemGrd.TextMatrix(i, 6)) & "','ON','" & Mlocation & "')"
      End If
