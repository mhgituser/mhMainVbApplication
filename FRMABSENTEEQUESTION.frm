...
Begin VB.Form FRMABSENTEEQUESTION 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "A B S E N T E E  Q U E S T I O N A R I E S "
   ClientHeight    =   8895
   ClientLeft      =   5025
   ClientTop       =   1050
   ClientWidth     =   10845
   Icon            =   "FRMABSENTEEQUESTION.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Moveable        =   0   'False
   ...
   Begin VB.Frame Frame3 
      ...
      Begin MSDataListLib.DataCombo cbostaffcode 
         Bindings        =   "FRMABSENTEEQUESTION.frx":0E42
         DataField       =   "ItemCode"
         Height          =   315
         Left            =   4920
         TabIndex        =   25
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton cmdotherquestion 
         Height          =   615
         Left            =   9480
         Picture         =   "FRMABSENTEEQUESTION.frx":0E57
         Style           =   1  'Graphical
         TabIndex        =   13
   ...
   Begin VB.Frame Frame1 
      ...
      Begin MSDataListLib.DataCombo cboabsenteeid 
         Bindings        =   "FRMABSENTEEQUESTION.frx":1509
         DataField       =   "ItemCode"
         Height          =   360
         Left            =   2520
         TabIndex        =   3
      ...
      Begin MSDataListLib.DataCombo CBOTRANID 
         Bindings        =   "FRMABSENTEEQUESTION.frx":151E
         DataField       =   "ItemCode"
         Height          =   360
         Left            =   7920
         TabIndex        =   37
   ...
   Begin MSComctlLib.ImageList IMG 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FRMABSENTEEQUESTION.frx":1533
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FRMABSENTEEQUESTION.frx":18CD
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FRMABSENTEEQUESTION.frx":1C67
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FRMABSENTEEQUESTION.frx":2941
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FRMABSENTEEQUESTION.frx":2D93
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FRMABSENTEEQUESTION.frx":354D
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "FRMABSENTEEQUESTION"
...
Set rs = Nothing
rs.Open "SELECT MAX(TRNID+1) AS MAXID  FROM TBLABSENTEEQUESTION", MHVDB
If rs.EOF <> True Then
...
RSTR.Open "select *  from tblabsenteeQUESTION WHERE ABSENTEEID='" & cboabsenteeid.BoundText & "' order by absenteeid", db
...
Dim rs As New ADODB.Recordset
Set rs = Nothing
rs.Open "SELECT * FROM TBLABSENTEEQUESTION WHERE ABSENTEEID='" & cboabsenteeid.BoundText & "' AND TRNID='" & CBOTRANID.BoundText & "' ", MHVDB
If rs.EOF <> True Then
...
Private Sub cmdotherquestion_Click()
ANAME = cboabsenteeid.BoundText
frmprequestionabsentee.Show 1
End Sub
...
Select Case Button.Key
      ...
      If Len(cboabsenteeid.Text) = 0 Then
        MsgBox "PLEASE SELECT ABSENTEE FOR THIS QUESTIONARY."
        cboabsenteeid.SetFocus
        Exit Sub
        End If
       MNU_SAVE
...
If rsAb.State = adStateOpen Then rsAb.Close
rsAb.Open "select distinct concat(A.absenteeid , ' ', absenteename) as absenteename,A.absenteeid  from tblabsentee AS A,TBLABSENTEEQUESTION AS B WHERE A.ABSENTEEID=B.ABSENTEEID  order by absenteeid", db
Set cboabsenteeid.RowSource = rsAb
cboabsenteeid.ListField = "absenteename"
cboabsenteeid.BoundColumn = "absenteeid"
...
If Len(cboabsenteeid.Text) = 0 Then
MsgBox "Please Select The Absentee Information From The Drop Down Controll.", , "MHV ERROR BOX"
Exit Sub
End If
MHVDB.BeginTrans
If Operation = "ADD" Then

MHVDB.Execute "insert into tblabsenteequestion (TRNID,absenteeid,qdate,question,followupdate,followupstaff,answer,talkedtoinf,infremarks,answercomplete)" _
            & "values('" & CBOTRANID.BoundText & "','" & cboabsenteeid.BoundText & "','" & Format(txtquestiondate.Value, "yyyyMMdd") & "'" _
...
MHVDB.Execute "UPDATE  tblabsenteequestion SET qdate='" & Format(txtquestiondate.Value, "yyyyMMdd") & "',question='" & txtquestion.Text & "',followupdate='" & Format(txtfollowupdate.Value, "yyyyMMdd") & "',followupstaff='" & cbostaffcode.BoundText & "',answer='" & txtanswer.Text & "',talkedtoinf='" & opttalkedtoinf & "',infremarks='" & txtinfremarks.Text & "',answercomplete='" & optanswercomplete & "' WHERE ABSENTEEID='" & cboabsenteeid.BoundText & "' AND TRNID='" & CBOTRANID.BoundText & "'"
